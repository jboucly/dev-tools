...
!(function (e, t) {
    ...
    function u(e, n, r) {
        ...
        return (
            (u || (!u && !r)) &&
                (('body' !== s(n) || l(c)) &&
                    (d = n !== t(n) && o(n) ? { scrollLeft: n.scrollLeft, scrollTop: n.scrollTop } : a(n)),
                o(n) ? (((h = i(n, !0)).x += n.clientLeft), (h.y += n.clientTop)) : c && (h.x = p(c))),
    ...
    function E(e, n) {
        if ('viewport' === n) {
            ...
            n &&
                ((s = n.width),
                (r = n.height),
                /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((l = n.offsetLeft), (u = n.offsetTop))),
        ...
        return (
            ...
            p
                ...
                : Object.assign(
                      {},
                      o,
                      (((n = {})[v] = a ? u + 'px' : ''), (n[m] = d ? e + 'px' : ''), (n.transform = ''), n)
                  )
        );
    }
    function T(e) {
                            ...
                            'auto' === x(n)
                                ? (function (e, t) {
                                      ...
                                      var p = i.reduce(function (t, i) {
                                          return (
                                              (t[i] = W(e, { placement: i, boundary: n, rootBoundary: o, padding: r })[
                                                  x(i)
                                              ]),
                                              t
                                          );
