...
!(function (t, e) {
    ...
    const s = (t) => {
        ...
        l = (t) =>
            a(t) ? (t.jquery ? t[0] : t) : 'string' == typeof t && t.length > 0 ? document.querySelector(t) : null,
        c = (t, e, i) => {
    ...
    class et extends R {
        ...
        _slide(t, e) {
            ...
            const u = () => {
                H.trigger(this._element, 'slid.bs.carousel', { relatedTarget: o, direction: d, from: n, to: r });
            };
    ...
    H.on(document, 'click.bs.carousel.data-api', '[data-bs-slide], [data-bs-slide-to]', et.dataApiClickHandler),
    ...
    H.on(document, 'keydown.bs.dropdown.data-api', '[data-bs-toggle="dropdown"]', pt.dataApiKeydownHandler),
    ...
    class bt {
        ...
        dispose() {
            this._isAppended &&
                (H.off(this._element, 'mousedown.bs.backdrop'), this._element.remove(), (this._isAppended = !1));
        }
        _emulateAnimation(t) {
